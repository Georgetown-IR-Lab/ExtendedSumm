...
#BERT_DIR=/disk1/sajad/datasets/sci/longsumm/new-abs-set//bert-files/512-whole-sectioned-raw-abs-relabled/
BERT_DIR=/disk1/sajad/datasets/sci/arxiv-dataset/bert-files/512-whole-sectioned-relabled-6/
...
MODEL_PATH=/disk1/sajad/sci-trained-models/presum/arxiv-512-whole-sectioned-baseline-classi/
...
CHECKPOINT=$MODEL_PATH/model_step_72000.pt # classi-cspubsum-multi-myIndex-alpha75
